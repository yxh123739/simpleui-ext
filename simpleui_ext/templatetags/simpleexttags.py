...
def table_item_type(item, instance):
    ...
    try:
        ...
        # 处理图片字段
            ...
            img_url = field_value.url if field_value and hasattr(
                field_value, 'url') else ''
        ...
        # 处理TagField
            ...
            if hasattr(model_field, 'tag_colors') and model_field.tag_colors and value in model_field.tag_colors:
